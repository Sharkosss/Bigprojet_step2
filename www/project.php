...
<?php 
  ...
  <html>
    ...
    <title><?php echo $projects["titlepage"]?></title>
        ...
        <div class="navbar colornav navbar-fixed">
          ...
          <ul id="slide-out" class="sidenav">
            <li><div class="user-view">
              ...
              <a href="#user">f<img class="circle" src="<?php echo $projects["imgintervenant"]?>"></a>
              <a href="#name">g<span class="white-text name"><?php echo $projects["nomintervenant"]?></span></a>
              <a href="#email">y<span class="white-text email"><a href="<?php echo $projects["linkedinhttps"]?>"><?php echo $projects["linkedin"]?></a></span></a>
            </div></li>
            ...
            <li><a href="project.php?id=<?php echo $project['id'] ?>"> <?php echo $project['pronoms']?></a></li>
            <?php
            }
            ?>
          </ul>
              ...
              <div></div>
                ...
                <div id="skills" class="section scrollspy">
                  <ul class="collapsible">
                    <li>
                      <div class="collapsible-header"><i class="material-icons"><?php echo $project["emoji1"]?></i><?php echo $projects["titlecomp1"]?></div>
                      <div class="collapsible-body"><span>
                        <?php echo $project["comp1"]?>
                      </span></div>
                    </li>
                    <li>
                      <div class="collapsible-header"><i class="material-icons"><?php echo $project["emoji2"]?></i><?php echo $projects["titlecomp2"]?></div>
                      <div class="collapsible-body"><span>
                      <?php echo $project["comp2"]?>
                      </span></div>
                    </li>
                    <li>
                      <div class="collapsible-header"><i class="material-icons"><?php echo $project["emoji3"]?></i><?php echo $projects["titlecomp3"]?></div>
                      <div class="collapsible-body"><span>
                      <?php echo $project["comp3"]?>
                      </span></div>
                    </li>
                    <li>
                      <div class="collapsible-header"><i class="material-icons"><?php echo $project["emoji4"]?></i><?php echo $projects["titlecomp4"]?></div>
                      <div class="collapsible-body"><span>
